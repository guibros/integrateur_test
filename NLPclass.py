...
class NLP:
    def __init__(self):
        ...
        self.phrases = [ #heure
                        ...
                        #aideAlutilisateur
                        u"j'aimerais parler à quelqu'un",
                        u"j'aimerais parler à un membre de ma famille",
                        u"j'aimerais parler à un proche",
                        u"j'aimerais parler à un proche aidant",
                        u"j'aimerais parler à un proche aidant",
                        u"j'aimerais parler à un spécialiste",
                        u"j'aimerais parler à un spécialiste de la santé",
                        u"j'aimerais parler à un infirmier",
                        u"j'aimerais parler à une infirmière",
                        u"j'aimerais parler à mon docteur",
                        u"j'aimerais parler à mon médecin",
                        u"j'aimerais parler à un docteur",
                        u"j'aimerais parler à un médecin",
                        u"j'aimerais parler aux services d'urgence",
                        u"j'aimerais contacter les services d'urgence",         
                        ]
    ...
    def analyze(self, text):           
        if text == "":
            ...
            if score >= 89:
                if modele in {  "quelle heure est-il",
                ...
                elif modele in {"Quelles sont mes médicaments"
                    ...
                    print("activité")
                    return "activite"
                elif modele in {"j'aimerais parler à quelqu'un",
                                "j'aimerais parler à un membre de ma famille",
                                "j'aimerais parler à un proche",
                                "j'aimerais parler à un proche aidant",
                                "j'aimerais parler à un proche aidant",
                                }:
                    print('contact proche')
                    return "contact proche"
                elif modele in {"j'aimerais parler à un spécialiste",
                                "j'aimerais parler à un spécialiste de la santé",
                                "j'aimerais parler à un infirmier",
                                "j'aimerais parler à une infirmière",
                                "j'aimerais parler à mon docteur",
                                "j'aimerais parler à mon médecin",
                                "j'aimerais parler à un docteur",
                                "j'aimerais parler à un médecin",
                                }:
                    print('contact santé') 
                    return "contact proche" 
                elif modele in {"j'aimerais parler aux services d'urgence",
                                "j'aimerais contacter les services d'urgence", 
                                }:
                    print('contact urgence') 
                    return "contact urgence"         
                # else: why no try except
    ...
    def motClef(self, text):
        if "heure" in text:
            ...
            print("aidant")
            return "contact proche"
        elif "spécialiste" in text:
            print("spécialiste")
            return "contact santé"
        elif "infirmier" in text or "infirmière" in text:
            print("infirmier")
            return "contact santé"
        elif "urgence" in text:
            print("urgence")
            return "contact urgence"
